# Aproximation Algorithms for NP-complete problems PA3
...
4. Return the cost of the traveling salesman tour computed by the nearest neighbor heuristic for this instance, rounded down to the nearest integer.
